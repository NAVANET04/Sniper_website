import { Users, Clock, Shield, CheckCircle, Lightbulb, Rocket, Sparkles, Wallet,BadgeCheck, Cloud, Globe2, TrendingUp, Eye, Compass, Zap, Cpu, Layers, Boxes, Clapperboard,GraduationCap, Glasses, PieChart } from "lucide-react";
import geometryvideo from "./assets/geometryanimation.mp4";
...
export const useCases = [
  {
    ...
    description: "Explore popular unity industry use cases that unlock the potential of 3D data to achieve real business goals",
    gradient: "linear-gradient(115deg, #1a1a2e 0%, #e0393e 28%, #f5a623 52%, #f7e35f 66%, #3fa9f5 100%)",
  },
  {
    tag: "USE CASE 02",
  ...
  },
  {
    ...
    description: "Explore popular unity industry use cases that unlock the potential of 3D data to achieve real business goals",
    gradient: "linear-gradient(115deg, #1a1030 0%, #2d1b52 40%, #5b3fd6 75%, #7c5cff 100%)",
  },
];

// Business Advantages of Real-Time 3D — bento grid
export const bentoItems = [
    { icon: Users,    label: "Improve engineering collaboration", description: "Engineers, architects, and designers work inside the same live 3D environment instead of passing static files back and forth.", bg: "from-violet-800/40 to-violet-950/40", span: "col-span-2 row-span-2", big: true },
    { icon: Rocket,   label: "Accelerate product development",    description: "Iterate on designs in real time and shorten the gap between concept and validated decision.", bg: "from-fuchsia-800/30 to-[#150826]" },
    { icon: Sparkles, label: "Enhance customer engagement",       description: "Let customers explore products in photorealistic, interactive detail before they buy.", bg: "from-violet-800/30 to-[#150826]" },
    { icon: Wallet,   label: "Reduce physical prototyping costs", description: "Validate designs virtually first, cutting down on costly physical mockups and rework.", bg: "from-violet-800/30 to-[#150826]" },
    { icon: Globe2,   label: "Support remote collaboration",      description: "Distributed teams review and iterate on the same live scene from anywhere.", bg: "from-fuchsia-800/30 to-[#150826]", span: "col-span-2" },
    { icon: TrendingUp, label: "Increase workforce productivity", description: "Faster reviews and fewer redo cycles mean teams spend more time building, less time waiting.", bg: "from-violet-800/30 to-[#150826]" },
    { icon: Eye,      label: "Improve operational visibility",    description: "Real-time dashboards turn operational data into something teams can actually see and act on.", bg: "from-violet-800/30 to-[#150826]" },
    { icon: Compass,  label: "Enable immersive decision-making",  description: "Walk through a facility or product before it's built, and make the call with real context.", bg: "from-fuchsia-800/30 to-[#150826]" },
    { icon: Zap,      label: "Drive digital transformation initiatives", description: "Real-time 3D becomes the shared visual layer connecting IoT, cloud, and AI initiatives.", bg: "from-violet-800/30 to-[#150826]" },
  ];
...
export const solutions = [
  {
    ...
    description: "Bring engineering designs, architectural models, manufacturing facilities, and operational data to life through interactive visualization.",
    descriptionn: "Applications include engineering and infrastructure visualization, facility walkthroughs, product showcases, executive dashboards, and customer demonstrations.",
    image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=1200&auto=format&fit=crop&q=70",
    tags: ["Engineering Visualization", "Facility Walkthroughs", "Executive Dashboards"],
  },
  {
    title: "Interactive Product Experiences",
    description: "Develop interactive product configurators and immersive sales experiences that let users personalize products and explore configurations in real time.",
    descriptionn: "Capabilities include product customization, interactive configurators, virtual showrooms, sales presentations, and online visualization platforms.",
    image: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=1200&auto=format&fit=crop&q=70",
    tags: ["Product Configurators", "Virtual Showrooms", "Sales Presentations"],
  },
  {
    title: "Enterprise Simulation & Training",
    description: "Build highly realistic simulations using Unreal Engine that improve workforce readiness while reducing operational risks and training costs.",
    descriptionn: "Applications include industrial safety training, equipment operation, maintenance procedures, emergency response, and healthcare simulation.",
    image: "https://images.unsplash.com/photo-1617802690992-15d93263d3a9?w=1200&auto=format&fit=crop&q=70",
    tags: ["Safety Training", "Equipment Simulation", "Emergency Response"],
  },
  {
    title: "Virtual Production Solutions",
    description: "Implement Unreal Engine-powered virtual production pipelines that improve efficiency while maintaining exceptional visual quality.",
    descriptionn: "Solutions include virtual studios, LED volume workflows, broadcast graphics, live event visualization, and motion capture integration.",
    image: "https://images.unsplash.com/photo-1601506521937-0121a7fc2a6b?w=1200&auto=format&fit=crop&q=70",
    tags: ["LED Volume", "Broadcast Graphics", "Motion Capture"],
  },
  {
    title: "Extended Reality (XR)",
    description: "Enable AR, VR, and mixed reality experiences that improve collaboration, remote assistance, design validation, and workforce training.",
    descriptionn: "Use cases include remote collaboration, virtual walkthroughs, interactive maintenance, product demonstrations, and smart manufacturing.",
    image: "https://images.unsplash.com/photo-1622979135225-d2ba269cf1ac?w=1200&auto=format&fit=crop&q=70",
    tags: ["Remote Collaboration", "Virtual Walkthroughs", "Smart Manufacturing"],
  },
];
  // Enterprise Solutions Built with Unreal Engine — capability card grid (3 top / 2 bottom)
export const keyFeatures = [
    {
      icon: Eye, title: "Real-Time Enterprise Visualization",
      description: "Bring engineering designs, architectural models, manufacturing facilities, industrial assets, and operational data to life through interactive visualization.",
      tags: ["Engineering visualization", "Infrastructure visualization", "Facility walkthroughs", "Product showcases"],
      moreCount: 2, span: "lg:col-span-2",
    },
    {
      icon: Boxes, title: "Interactive Product Experiences",
      description: "These solutions help organizations improve customer engagement, shorten sales cycles, and enhance buying confidence.",
      tags: ["Product customization", "Interactive configurators", "Virtual showrooms", "Sales presentations"],
      moreCount: 2, span: "lg:col-span-2",
    },
    {
      icon: GraduationCap, title: "Enterprise Simulation & Training",
      description: "Using Unreal Engine, organizations can build highly realistic simulations that improve workforce readiness while reducing operational risks.",
      tags: ["Industrial safety training", "Equipment operation", "Maintenance procedures", "Emergency response"],
      moreCount: 3, span: "lg:col-span-2",
    },
    {
      icon: Clapperboard, title: "Virtual Production Solutions",
      description: "Implement Unreal Engine-powered virtual production pipelines that improve efficiency while maintaining exceptional visual quality.",
      tags: ["Virtual studios", "LED volume workflows", "Broadcast graphics", "Motion capture integration"],
      moreCount: 3, span: "lg:col-span-3",
    },
    {
      icon: Glasses, title: "Extended Reality (XR)",
      description: "Enable AR, VR, and mixed reality experiences for remote collaboration, design validation, and workforce training.",
      tags: ["Remote collaboration", "Virtual walkthroughs", "Interactive maintenance", "Smart manufacturing"],
      moreCount: 3, span: "lg:col-span-3",
    },
  ];
  // Why Organizations Choose Sniper — bento grid
export const partnerItems = [
      { icon: BadgeCheck,      label: "Authorized Unreal Engine Partner",   bg: "from-violet-800/40 to-violet-950/40", span: "col-span-2 row-span-2", big: true },
      { icon: Users,           label: "Enterprise-focused consulting",      bg: "from-fuchsia-800/30 to-[#150826]" },
      { icon: Compass,         label: "Experienced solution architects",    bg: "from-violet-800/30 to-[#150826]" },
      { icon: Layers,          label: "Industry-specific expertise",        bg: "from-violet-800/30 to-[#150826]" },
      { icon: Cloud,           label: "Cloud and AI integration",           bg: "from-fuchsia-800/30 to-[#150826]", span: "col-span-2" },
      { icon: Boxes,           label: "End-to-end implementation",          bg: "from-violet-800/30 to-[#150826]" },
      { icon: Globe2,          label: "Pan-India delivery and support",     bg: "from-violet-800/30 to-[#150826]" },
      { icon: Zap,             label: "Managed services and optimization",  bg: "from-fuchsia-800/30 to-[#150826]" },
      { icon: TrendingUp,      label: "Long-term technology partnership",   bg: "from-violet-800/30 to-[#150826]" },
      { label: "Cloud & AI Integration", description: "...",  video: geometryvideo, tag: "Managed Services" }
    ];
export const faqs = [
    { question: "Why Unreal Engine for enterprise?", answer: "Unreal Engine offers photorealistic rendering, real-time collaboration, and cross-platform deployment — giving enterprises a single ecosystem for visualization, simulation, and immersive training." },
    { question: "Can you integrate with ERP systems?", answer: "Yes. We build custom data pipelines that connect Unreal Engine applications with ERP, PLM, and IoT platforms so your visualizations stay in sync with live operational data." },
    { question: "Do you build Digital Twins?", answer: "We develop enterprise digital twins that combine IoT sensor data, cloud platforms, and AI analytics for real-time monitoring, predictive maintenance, and operational insight." },
    { question: "Do you provide long-term support?", answer: "Yes — we offer managed services, ongoing optimization, and pan-India technical support for every Unreal Engine solution we deliver." },
    { question: "Can existing CAD models be imported?", answer: "Most industry-standard CAD and BIM formats can be imported and optimized for real-time rendering in Unreal Engine, preserving engineering accuracy." },
  ];
