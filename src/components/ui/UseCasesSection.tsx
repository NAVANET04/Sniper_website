...
const KEY_USE_CASES = [
  {
    ...
    gradient: "linear-gradient(115deg, #0a0118 0%, #ff5a3c 32%, #ffd23f 55%, #29b6f6 80%, #3a1c9e 100%)",
  },
  {
    tag: "USE CASE 02",
    ...
    gradient: "linear-gradient(115deg, #2fb8f6 0%, #6a7bf0 50%, #8a4bf5 100%)",
  },
  {
    tag: "USE CASE 03",
    ...
    gradient: "linear-gradient(115deg, #ffb3c6 0%, #ff8fb0 45%, #f7c6d9 100%)",
  },
  {
    tag: "USE CASE 04",
    ...
    gradient: "linear-gradient(115deg, #dcd0ff 0%, #6a3ccf 40%, #0a0118 100%)",
  },
];
  ...
  return (
    <FadeUp delay={0.05 * index} className="h-full">
      <div
        ...
        ring-1 ring-black/[0.04] transition-shadow duration-300 hover:shadow-[0_8px_24px_rgba(0,0,0,0.12)]"
      >
        {/* Thumbnail — flat banner ratio, matches the reference proportions
            instead of a tall, oversized hero image */}
        <div
          className="relative w-full aspect-[12/5] overflow-hidden rounded-xl"
          style={{ backgroundImage: useCase.gradient }}
        >
          <span
